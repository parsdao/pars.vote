...
import { CyrusLogoSimple } from '../../../../assets/theme/custom/icons/CyrusLogo';
import {
    ...
    >
            ...
            >
              <Flex p="1rem">
                <Link
                  ...
                  onClick={onClose}
                >
                  <CyrusLogoSimple boxSize="1.5rem" color="white" />
                </Link>
              </Flex>
              <Flex
                height="full"
      ...
      <Show above="md">
        <Link
          ...
          aria-label={t('ariaLabelFractalBrand')}
        >
          <CyrusLogoSimple boxSize="1.5rem" color="white" mr="1.75rem" />
        </Link>
      </Show>
    </Flex>
  );
